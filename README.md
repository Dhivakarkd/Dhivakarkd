...
const dhivakar = {
  ...
  askMeAbout: ["Java", "Spring Boot", "Kafka", "Gradle", "Control-M", "JSR"],
...
### 💼 [WalletWatch](https://github.com/Dhivakarkd/WalletWatch/)

**Full-Stack Expense Manager**

A comprehensive expense tracking application combining the power of Flutter for a beautiful cross-platform UI and Spring Boot for a robust backend.
...
I'm constantly building and learning. Check out my repositories for:
